...
class __TwigTemplate_d94a0fa6096764929379aa21969ab7e4a3911a1efa4d50493a7b7c1817db6f0b extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 37, $this->source); })()), "dumpsCount", [], "any", false, false, false, 37), 0))) ? ("disabled") : (""));
        echo "\">
        <span class=\"icon\">";
        // line 38
        echo twig_include($this->env, $context, "@Debug/Profiler/icon.svg");
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/home/vitkov/ipssi/symfony/rocket-symfony/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
