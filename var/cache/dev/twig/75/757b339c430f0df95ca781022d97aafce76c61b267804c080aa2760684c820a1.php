...
class __TwigTemplate_a714f7fc73788f2979f77dede8ec3053ecb4e919c3c6a08a88e7b814791c62cb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        <div class=\"sf-tabs\">
            ...
            <div class=\"tab ";
            // line 88
            echo ((( !(isset($context["has_error_logs"]) || array_key_exists("has_error_logs", $context) ? $context["has_error_logs"] : (function () { throw new RuntimeError('Variable "has_error_logs" does not exist.', 88, $this->source); })()) && (1 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 88, $this->source); })()), "countdeprecations", [], "any", false, false, false, 88), 0)))) ? ("active") : (""));
            echo "\">
                ";
            // line 91
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/home/vitkov/ipssi/symfony/rocket-symfony/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig");
    }
}
